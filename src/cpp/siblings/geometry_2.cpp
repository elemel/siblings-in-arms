...
namespace siblings {
    ...
    real squared_distance(const circle_2<real>& c, const rectangle_2<real>& r)
    {
    ...
    real squared_distance(const rectangle_2<real>& r, const circle_2<real>& c)
    {
        return squared_distance(c, r);
    }

    real squared_distance(const rectangle_2<real>& a,
                          const rectangle_2<real>& b)
    {
    ...
    real squared_distance(const rectangle_2<real>& r, const vector_2<real>& v)
    {
    ...
    real squared_distance(const vector_2<real>& v, const rectangle_2<real>& r)
    {
    ...
    bool intersects(const circle_2<real>& c, const rectangle_2<real>& r)
    {
        return squared_distance(r, c.center()) < square(c.radius());
    }

    bool intersects(const rectangle_2<real>& r, const circle_2<real>& c)
    {
        return intersects(c, r);
    }

    bool intersects(const rectangle_2<real>& a, const rectangle_2<real>& b)
    {
    ...
    circle_2<real> bounding_circle(const rectangle_2<real>& r)
    {
    ...
    rectangle_2<real> bounding_rectangle(const circle_2<real>& c)
    {
        return rectangle_2<real>(c.center() - vector_2<real>(c.radius()),
                           c.center() + vector_2<real>(c.radius()));
    }

    const rectangle_2<real>& bounding_rectangle(const rectangle_2<real>& r)
    {
        return r;
    }

    rectangle_2<real> bounding_rectangle(const vector_2<real>& v)
    {
        return rectangle_2<real>(v, v);
    }
}
