...
namespace siblings {
    ...
    real squared_distance(const circle_2& c, const vector_2<real>& v)
    {
    ...
    real squared_distance(const vector_2<real>& v, const circle_2& c)
    {
    ...
    circle_2 bounding_circle(const vector_2<real>& v)
    {
