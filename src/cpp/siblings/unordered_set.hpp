...
namespace siblings {
    /// Implementation of 23.4.3, class template unordered_set.
    ///
    /// @author Mikael Lind
    ///
    ...
    private:
        /// Implementation type.
        typedef detail::unordered_container<Value, Value, identity<Value>,
                                            Hash, Pred, Alloc>
        impl_type;
    ...
    public:
        ...
        /// @copydoc detail::unordered_container::cend
